...
- [Dashboard API](/docs/api-reference/dashboard) — shared announcement endpoint
- [Roles & Permissions](/docs/development/roles-and-permissions) — who can create announcements
