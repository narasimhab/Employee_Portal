...
::: info
This page summarizes Phase 1. The full long-form notes live in `docs/PHASE1_SETUP.md`.
:::
...
Continue to [Phase 2 — Authentication](/phase-guides/phase-2-authentication).
